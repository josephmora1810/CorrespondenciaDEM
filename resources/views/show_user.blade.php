                        ...
                        <table class="table">
                            <thead>
                                <tr class="bg-gray-700 dark:bg-dark-1 text-white">
                                    ...
                                    <th class="whitespace-nowrap">Creado en</th>
                            ...
                            @foreach($users as $user)
                                <tr>
                                    <td class="border-b dark:border-dark-5">{{$user->id}}</td>
                                    ...
                                    <a href="{{url('editcat')}}/{{$user->id}}">
                                        <i data-feather="edit" style="color:green;"></i>
                                    </a>
                                    |
                                    <a onclick="return confirm('Do you want to delete it')" href="{{url('/cat/destroy/')}}/{{$user->id}}">
